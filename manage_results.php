...
<body>
    ...
    <div class="title">
        <a href="welcome.php"><img src="./images/logo1.png" alt="" class="logo"></a>
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <?php
                    ...
                    $class_result=mysqli_query($conn,"SELECT `Cources` FROM `classes`");
                        echo '<select name="Cources">';
...
<?php
    if(isset($_POST['Cources'],$_POST['rno'])) {
        $class_name=$_POST['Cources'];
        $rno=$_POST['rno'];
        echo $class_name;
        echo $rno;
        $delete_sql=mysqli_query($conn,"DELETE from `results` where `rno`='$rno' and `Cource`='$class_name'");
        if(!$delete_sql){
    ...
    if(isset($_POST['rn'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['classes'])) {
        $rno=$_POST['rn'];
        ...
        $sql="UPDATE `results` SET `s1`='$p1',`s2`='$p2',`s3`='$p3',`s4`='$p4',`s5`='$p5',`marks`='$marks',`percentage`='$percentage' WHERE `rno`='$rno' and `Cource`='$class_name'";
